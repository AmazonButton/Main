  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4 sm:p-6 telemetry-grid relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white/95 backdrop-blur-2xl border border-slate-200/80 rounded-3xl p-8 sm:p-10 shadow-2xl shadow-slate-200/50 relative z-10 transition-all">
        {/* Header Icon */}
        <div className="w-14 h-14 rounded-2xl bg-blue-500/10 border border-blue-500/25 text-blue-600 flex items-center justify-center mx-auto mb-4 shadow-sm">
        ...
        {submitted ? (
          <div className="space-y-5 animate-in fade-in zoom-in-95 duration-200">
            <div className="p-4 rounded-2xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-800 text-xs flex items-start gap-3">
            ...
            {devResetToken && (
              <div className="p-3 bg-amber-500/10 border border-amber-500/20 rounded-xl text-xs text-amber-800">
                ...
                <Link
                  ...
                  className="font-mono text-[11px] text-blue-600 underline break-all"
                >
            ...
            <div className="pt-2 flex flex-col gap-2.5">
              <button
                ...
                className="w-full py-3 px-4 rounded-xl border border-slate-200 text-slate-700 font-bold text-xs hover:bg-slate-50 transition-all disabled:opacity-50"
              >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 text-xs rounded-xl bg-slate-50 border border-slate-200 text-slate-900 font-mono focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 transition-all"
                />
              </div>
            </div>
