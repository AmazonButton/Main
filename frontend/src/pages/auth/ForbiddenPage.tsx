...
export const ForbiddenPage: React.FC = () => {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center p-4 sm:p-6 telemetry-grid relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white/95 backdrop-blur-2xl border border-slate-200/80 rounded-3xl p-8 sm:p-10 shadow-2xl shadow-slate-200/50 text-center relative z-10 transition-all animate-in fade-in zoom-in-95 duration-200">
        ...
        <span className="inline-block px-3 py-1 rounded-full bg-rose-500/10 text-rose-600 font-mono font-bold text-xs mb-2">
        ...
        {user && (
          <div className="my-5 p-3.5 bg-slate-50 border border-slate-200 rounded-2xl text-xs flex items-center justify-between font-mono">
        ...
        <div className="pt-2 grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <button
            ...
            className="py-3 px-4 rounded-xl border border-slate-200 text-slate-700 hover:bg-slate-50 font-bold text-xs transition-all flex items-center justify-center gap-2"
          >
