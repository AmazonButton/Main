    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 p-6 bg-white border border-slate-200/80 rounded-3xl shadow-sm">
        <div className="flex items-center space-x-3.5">
          <div className="w-12 h-12 rounded-2xl bg-rose-50 text-rose-500 flex items-center justify-center border border-rose-500/20 shadow-inner">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-0.5">
              Phát hiện tấn công Replay, vi phạm độ lệch thời gian NTP, sai chữ ký HMAC-SHA256 & gói tin bất hợp lệ
            </p>
          </div>
        </div>
        ...
        <button
          ...
          className="px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold flex items-center space-x-1.5 transition-colors"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="p-4 bg-white border border-slate-200/80 rounded-2xl shadow-sm">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <span className="text-sm font-bold text-slate-900">Active (Hardware Crypto)</span>
          </div>
        </div>
        ...
        <div className="p-4 bg-white border border-slate-200/80 rounded-2xl shadow-sm">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <span className="text-sm font-bold text-slate-900">Enforced (Nonce Cache)</span>
          </div>
        </div>
        ...
        <div className="p-4 bg-white border border-slate-200/80 rounded-2xl shadow-sm">
          ...
          <div className="flex items-center gap-2 mt-2">
            ...
            <span className="text-sm font-bold text-slate-900">Dung Sai ±300s</span>
          </div>
        </div>
              ...
              <tbody className="divide-y divide-slate-100">
                {incidents.map((inc, i) => (
                  <tr key={i} className="hover:bg-slate-50/60">
                    ...
                    <td className="py-2.5 px-3 text-slate-700">{inc.reason}</td>
                  </tr>
                ))}
              </tbody>
            </table>
